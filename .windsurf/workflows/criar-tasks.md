...
<system_instructions>
    ...
    - Template para a lista de tarefas: `C:\Users\gustavo.trindade\.codeium\windsurf\TEMPLATES_WORKFLOWS\tasks.md`
    - Lista de tarefas: `./tasks/prd-[nome-funcionalidade]/tasks.md`
    - Template para cada tarefa individual: `C:\Users\gustavo.trindade\.codeium\windsurf\TEMPLATES_WORKFLOWS\task.md`
    - Tarefas individuais: `./tasks/prd-[nome-funcionalidade]/[num]_task.md`

    ### Formato do Resumo de Tarefas (tasks.md)

    - **SEGUIR ESTRITAMENTE O TEMPLATE EM `C:\Users\gustavo.trindade\.codeium\windsurf\TEMPLATES_WORKFLOWS\tasks.md`**

    ### Formato de Tarefa Individual ([num]_task.md)

    - **SEGUIR ESTRITAMENTE O TEMPLATE EM `C:\Users\gustavo.trindade\.codeium\windsurf\TEMPLATES_WORKFLOWS\task.md`**
