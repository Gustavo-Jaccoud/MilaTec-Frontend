...
```
    ...
    <critical>**CONSIDERE, PARA TAREFAS MAIS COMPLEXAS (HIGH), SEGUIR UM PROCESSO DE RED-GREEN-REFACTOR (Test-Driven Development) ONDE OS TESTES SÃO CRIADOS ANTES DA IMPLEMENTAÇÃO**</critical>
