          ...
          <Col xxl={3} lg={5} md={6}>
            ...
            <Card className="overflow-hidden text-center p-xxl-4 p-3 mb-0">
              <div className="text-center">
                ...
                <h3 className="mt-3 mb-2">Acesso Negado!</h3>
                <p className="text-muted mb-3">
                  Você não tem autorização para visualizar esta página. Se você
                  acha que isso é um erro, entre em contato com o suporte para
                  assistência.
                </p>
